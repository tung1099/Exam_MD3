...
public class ProductDAO {
    ...
    private static final String FIND_ALL_PRODUCT = "select p.id,p.name,price,quantity,color,description,c.name from product p join productmanager.category c on c.id = p.id_category;";
